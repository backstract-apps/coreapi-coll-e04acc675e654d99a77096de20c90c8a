...
async def post_b_user(db: Session, id: int, first_name: str, last_name: str, age: int):
    ...
    user_record = db.query(models.B_user).filter(models.B_user.id == b_user_inserted_record.id).first()
    res = {
